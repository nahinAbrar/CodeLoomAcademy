...
import { registrationUser,activateUser, loginUser, logoutUser,  getUserInfo, socialAuth, updateUserInfo, updatePassword, updateProfilePicture, getAllUsersAdmin, updateUserRole, deleteUser, updateAccessToken } from '../controllers/userController';

                ...
                return (
                    <div className={`${!props.isDemo && 'border-b border-[#ffffff8e pb-2]'}`} key={section}>
                        ...
                        <h5 className='text-black dark:text-white'>
                            ...
                            {sectionVideoLength < 60 ? sectionVideoLength : sectionVideoLength.toFixed(2)}{" "}
                        ...
                        {isSectionVisible && (
                            <div className='w-full'>
                                {sectionVideos.map((item: any, index: number) => {
                                    ...
                                    return (
                                        <div className={`w-full ${videoIndex === props.activeVideo ? "bg-slate-800" : ""} cursor-pointer transition-all p-2`}
                                            key={item._id}
                                            ...
                                            <h5 className='pl-8 text-black dark:text-white'>
                                                ...
                                                {item.videLength > 60 ? "hours" : "minutes"}
                                            </h5>
                                        </div>
                                    )
                                })}

                ...
                <div className='w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-10 rounded'>
                    ...
                    <div className='dark:bg-[#2d3a4ea1] bg-[#00000013] font-Montserrat border-b dark:border-b-[#ffffff47] border-b-[#0000000f]'>
                        ...
                        <p className='px-2 text-black dark:text-white'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis qui tenetur rem eveniet, fuga iure quaerat omnis perferendis. Laudantium sequi magnam dolor reiciendis eveniet sint quaerat aliquid facilis excepturi distinctio.
                        </p>
